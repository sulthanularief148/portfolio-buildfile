...
import { Link } from "lucide-react"; // ✅ Replaced GitHub icon with Link icon
      ...
      >
        <div className="relative w-full h-[200px] sm:h-[230px]">
          ...
          <div className="absolute inset-0 flex justify-end m-3 card-img_hover">
            ...
            >
              {/* ✅ Using Lucide's Link icon instead of GitHub image */}
        ...
        <div className="mt-5">
          <h3 className="text-[#C552EC] font-bold text-[20px] sm:text-[24px]">
            {name}
          </h3>
...
const Works = () => {
  return (
    <>
      ...
      {/* ✅ Adjusted flex for mobile responsiveness */}
